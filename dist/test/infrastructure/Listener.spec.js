...
describe('Listener', () => {
    ...
    describe('onerror', () => {
        it('should reject because of wrong server url', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield listener.open()
                ...
                .catch((error) => {
                listener.close();
                chai_1.expect(error.message.toString()).to.contain("getaddrinfo ENOTFOUND notcorrecturl");
            });
        }));
    });
});

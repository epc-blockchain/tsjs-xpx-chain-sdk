...
// ===============================================
var ExchangeRoutesApiApiKeys;
(function (ExchangeRoutesApiApiKeys) {
})(ExchangeRoutesApiApiKeys = exports.ExchangeRoutesApiApiKeys || (exports.ExchangeRoutesApiApiKeys = {}));
class ExchangeRoutesApi {
    ...
    setApiKey(key, value) {
        this.authentications[ExchangeRoutesApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    getAccountExchangeOffers(accountId, options = { headers: {} }) {
     ...
     */
    getExchangeOffers(offerType, mosaicId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Array<ExchangesDTO>");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
...
exports.ExchangeRoutesApi = ExchangeRoutesApi;
//# sourceMappingURL=exchangeRoutesApi.js.map
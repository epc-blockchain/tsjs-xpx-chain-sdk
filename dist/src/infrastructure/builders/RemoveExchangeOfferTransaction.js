...
const { RemoveExchangeOfferTransactionBuffer, RemoveExchangeOfferBuffer, } = ExchangeOfferTransactionBuffer_1.default.Buffers;
const flatbuffers_1 = require("flatbuffers");
const RemoveExchangeOfferTransactionSchema_1 = require("../schemas/RemoveExchangeOfferTransactionSchema");
/**
 * @module transactions/RemoveExchangeOfferTransaction
 */
class RemoveExchangeOfferTransaction extends VerifiableTransaction_1.VerifiableTransaction {
    constructor(bytes) {
        super(bytes, RemoveExchangeOfferTransactionSchema_1.default);
    }
}
exports.default = RemoveExchangeOfferTransaction;
// tslint:disable-next-line:max-classes-per-file
class Builder {
    constructor() {
        this.maxFee = [0, 0];
        this.type = TransactionType_1.TransactionType.REMOVE_EXCHANGE_OFFER;
    }
    addSize(size) {
        this.size = size;
        return this;

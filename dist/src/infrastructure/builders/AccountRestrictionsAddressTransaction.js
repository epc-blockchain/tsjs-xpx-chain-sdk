...
const AccountRestrictionsAddressModificationTransactionSchema_1 = require("../schemas/AccountRestrictionsAddressModificationTransactionSchema");
...
class AccountRestrictionsAddressTransaction extends VerifiableTransaction_1.VerifiableTransaction {
    constructor(bytes) {
        super(bytes, AccountRestrictionsAddressModificationTransactionSchema_1.default);
    }
}
exports.default = AccountRestrictionsAddressTransaction;
// tslint:disable-next-line:max-classes-per-file
class Builder {
    constructor() {
        this.maxFee = [0, 0];
        this.type = TransactionType_1.TransactionType.MODIFY_ACCOUNT_RESTRICTION_ADDRESS;
    }
    addSize(size) {
        this.size = size;
        return this;
    ...
    build() {
        ...
        this.modifications.forEach((modification) => {
            const addressModificationVector = PropertyModificationBuffer
            ...
            PropertyModificationBuffer.addValue(builder, addressModificationVector);
...
//# sourceMappingURL=AccountRestrictionsAddressTransaction.js.map
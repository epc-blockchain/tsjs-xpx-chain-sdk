...
/**
 * @module schema/AddExchangeOfferTransactionSchema
 */
/**
 * AddExchangeOffer transaction schema
...
exports.default = new Schema_1.Schema([
    ...
    Schema_1.tableArray('offers', [
        ...
        Schema_1.array('mosaicAmount', Schema_1.TypeSize.INT),
        Schema_1.array('cost', Schema_1.TypeSize.INT),
        Schema_1.ubyte('type'),
        Schema_1.array('duration', Schema_1.TypeSize.INT),
    ])
]);
//# sourceMappingURL=AddExchangeOfferTransactionSchema.js.map
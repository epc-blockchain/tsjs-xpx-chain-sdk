...
import { CosignatureSignedTransaction } from '../model/model';
/**
...
export declare class AggregateTransactionService {
     ...
     * @param cosignatures
     */
    static addCosignatures(signedTransaction: SignedTransaction, cosignatures: CosignatureSignedTransaction[]): SignedTransaction;
}

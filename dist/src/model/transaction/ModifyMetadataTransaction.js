...
class ModifyMetadataTransaction extends Transaction_1.Transaction {
    ...
    toJSON() {
        ...
        return Object.assign(Object.assign({}, parent), { transaction: Object.assign(Object.assign({}, parent.transaction), { metadataType: this.metadataType, metadataId: this.metadataId, modifications: this.modifications.map(modification => {

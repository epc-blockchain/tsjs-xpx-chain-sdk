...
class LockFundsTransaction extends Transaction_1.Transaction {
    ...
    toJSON() {
        ...
        return Object.assign(Object.assign({}, parent), { transaction: Object.assign(Object.assign({}, parent.transaction), { mosaicId: this.mosaic.id.id.toDTO(), amount: this.mosaic.amount.toDTO(), duration: this.duration.toDTO(), hash: this.hash }) });
    }
    /**
     * @internal

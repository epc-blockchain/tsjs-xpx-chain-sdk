...
class ModifyMultisigAccountTransaction extends Transaction_1.Transaction {
    ...
    toJSON() {
        ...
        return Object.assign(Object.assign({}, parent), { transaction: Object.assign(Object.assign({}, parent.transaction), { minApprovalDelta: this.minApprovalDelta, minRemovalDelta: this.minRemovalDelta, modifications: this.modifications.map((modification) => {

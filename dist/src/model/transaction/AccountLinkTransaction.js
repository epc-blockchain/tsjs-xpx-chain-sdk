...
class AccountLinkTransaction extends Transaction_2.Transaction {
    ...
    toJSON() {
        ...
        return Object.assign(Object.assign({}, parent), { transaction: Object.assign(Object.assign({}, parent.transaction), { remoteAccountKey: this.remoteAccountKey, action: this.linkAction }) });
    }
    /**
     * @internal

...
class SecretProofTransaction extends Transaction_1.Transaction {
    ...
    toJSON() {
        ...
        return Object.assign(Object.assign({}, parent), { transaction: Object.assign(Object.assign({}, parent.transaction), { hashAlgorithm: this.hashType, secret: this.secret, recipient: this.recipient.toDTO(), proof: this.proof }) });
    }
    /**
     * @internal

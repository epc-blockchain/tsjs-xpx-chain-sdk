...
class TransferTransaction extends Transaction_2.Transaction {
    ...
    toJSON() {
        ...
        return Object.assign(Object.assign({}, parent), { transaction: Object.assign(Object.assign({}, parent.transaction), { recipient: this.recipient.toDTO(), mosaics: this.mosaics.map((mosaic) => {
                    return mosaic.toDTO();

...
class MosaicAliasTransaction extends Transaction_1.Transaction {
    ...
    toJSON() {
        ...
        return Object.assign(Object.assign({}, parent), { transaction: Object.assign(Object.assign({}, parent.transaction), { aliasAction: this.actionType, namespaceId: this.namespaceId.toDTO(), mosaicId: this.mosaicId.toDTO() }) });
    }
    /**
     * @internal

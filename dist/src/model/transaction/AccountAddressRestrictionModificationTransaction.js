...
class AccountAddressRestrictionModificationTransaction extends Transaction_1.Transaction {
    ...
    toJSON() {
        ...
        return Object.assign(Object.assign({}, parent), { transaction: Object.assign(Object.assign({}, parent.transaction), { restrictionType: this.restrictionType, modifications: this.modifications.map((modification) => {

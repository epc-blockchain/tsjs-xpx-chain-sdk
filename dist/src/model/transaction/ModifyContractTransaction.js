...
class ModifyContractTransaction extends Transaction_1.Transaction {
    ...
    toJSON() {
        ...
        return Object.assign(Object.assign({}, parent), { transaction: Object.assign(Object.assign({}, parent.transaction), { durationDelta: this.durationDelta, hash: this.hash, customers: this.customers.map(customer => {

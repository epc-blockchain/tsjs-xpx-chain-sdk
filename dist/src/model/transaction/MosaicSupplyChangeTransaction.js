...
class MosaicSupplyChangeTransaction extends Transaction_1.Transaction {
    ...
    toJSON() {
        ...
        return Object.assign(Object.assign({}, parent), { transaction: Object.assign(Object.assign({}, parent.transaction), { mosaicId: this.mosaicId.toDTO(), direction: this.direction, delta: this.delta.toDTO() }) });
    }
    /**
     * @internal

...
export declare class AggregateTransaction extends Transaction {
     ...
     */
    signTransactionWithCosignatories(initiatorAccount: Account, cosignatories: Account[], generationHash: string, signSchema?: SignSchema): SignedTransaction;
    /**
     ...
     */
    signTransactionGivenSignatures(initiatorAccount: Account, cosignatureSignedTransactions: CosignatureSignedTransaction[], generationHash: string, signSchema?: SignSchema): SignedTransaction;
    /**
